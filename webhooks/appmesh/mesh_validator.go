...
func (m *meshValidator) Prototype(req admission.Request) (runtime.Object, error) {
	return &appmesh.Mesh{}, nil
}

func (m *meshValidator) ValidateCreate(ctx context.Context, obj runtime.Object) error {
	return nil
}

func (m *meshValidator) ValidateUpdate(ctx context.Context, obj runtime.Object, oldObj runtime.Object) error {
	mesh := obj.(*appmesh.Mesh)
	oldMesh := oldObj.(*appmesh.Mesh)
	if err := m.enforceFieldsImmutability(mesh, oldMesh); err != nil {
		return err
	}
	return nil
}

func (m *meshValidator) ValidateDelete(ctx context.Context, obj runtime.Object) error {
	return nil
}

// enforceFieldsImmutability will enforce immutable fields are not changed.
func (m *meshValidator) enforceFieldsImmutability(mesh *appmesh.Mesh, oldMesh *appmesh.Mesh) error {
...
func (m *meshValidator) SetupWithManager(mgr ctrl.Manager) {
	mgr.GetWebhookServer().Register(apiPathValidateAppMeshMesh, webhook.NewValidatingWebhook(m))
}
